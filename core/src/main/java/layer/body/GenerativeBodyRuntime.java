...
import layer.kernel.CandidateType;
import layer.kernel.Kernel;
import layer.kernel.KernelFactory;
...
public final class GenerativeBodyRuntime {
    private static final Kernel KERNEL = KernelFactory.withProvider(ProviderRegistry.resolve(ProviderConfig.empty()));
    ...
    public static GenerativeBodyRegistry createStandardRegistry(Kernel kernel) {
