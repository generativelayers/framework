 ...
 * <h2>Architecture</h2>
 * <pre>
 *   ResourceActions (interface)   -- canonical 13-command GL v2 contract
 *       -> implemented by
 *   DirectAdapter (concrete)      -- provider binding, governed invocation,
 ...
 * <h2>Adapters</h2>
 * <ul>
 *   <li>{@link gl.adapter.ResourceActions} -- 13-command interface</li>
