...
/**
 * Jason Internal Action: {@code .gl.adapter.jason.actions.configure(Key, Value)}.
 *
 * <p>Delegates to {@link gl.adapter.ResourceActions#configure(String, String)}.
 */
public class configure extends DefaultInternalAction {
    ...
    public Object execute(TransitionSystem ts, Unifier un, Term[] args) throws Exception {
        ...
        return JasonAdapter.instance().configure(key, value);
    }
}
