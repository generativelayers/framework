...
/**
 * Jason Internal Action: {@code .gl.adapter.jason.actions.invoke(AgentId, GoalId, BodyId, Affordance, Prompt, RequiredCsv, ResultId)}.
 *
 * <p>Delegates to {@link gl.adapter.ResourceActions#invoke(String, String, String, String, String, String)}.
 */
