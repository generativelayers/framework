...
/** Immutable, content-addressed storage unit for prompts, outputs, and evidence.
 *  Every prompt sent and every output received is stored as a Blob for auditability. */
