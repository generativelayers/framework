...
/** Full audit trail for a single generation invocation.
 *  Links request > prompt blob > output blob > candidate > outcome,
 *  with governance policy and validation results attached. */
