package generativelayers.provider.gemini;

import generativelayers.kernel.Blob;
import generativelayers.kernel.KernelPorts;
import generativelayers.kernel.ProviderOutput;
import generativelayers.kernel.ResourceRequest;
...
public final class GeminiProvider implements KernelPorts.GenerativeProvider {
    ...
    /**
     * Factory method — called by {@link generativelayers.provider.ProviderRegistry} via reflection.
