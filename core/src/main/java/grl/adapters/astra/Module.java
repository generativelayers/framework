 ...
 *       string resultId = grl.invoke("agent", "goal", "llm.answer",
 *                                     "ANSWER", "prompt", "field1,field2");
 *       boolean isValid = grl.valid(resultId);
 *       if (isValid) { grl.accept(grl.candidate(resultId)); }
 *   }
 * </pre>
 */
